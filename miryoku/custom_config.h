...
&tdto_z_plain,        &kp X,                &kp C,                &kp V,                &kp B,                /***/   &kp N,                &kp M,                U_COMMA_SEMI,         U_DOT_COLON,          U_FSLH_BSLH,           \
...
&kp LSHFT,            U_MT(LCTRL, U_CUT),   U_MT(LOPT, U_CPY),    U_MT(LCMD, U_PST),    &kp LHYPER,           /***/   U_MT(RHYPER, H),      U_MT(RCMD, J),        U_MT(ROPT, K),        U_MT(RCTRL, L),       U_MT(RSHFT, SQT),      \
&tdto_base,           &kp DEL,              &kp BSPC,             &kp RET,              &kp PG_DN,            /***/   &kp N,                &kp M,                U_COMMA_SEMI,         U_DOT_COLON,          U_FSLH_BSLH,           \
...
&kp LSHFT,            U_MT(LCTRL, U_CUT),   U_MT(LOPT, U_CPY),    U_MT(LCMD, U_PST),    &kp LHYPER,           /***/   &u_caps_word,         &kp LEFT,             &kp DOWN,             &kp RIGHT,            U_NU,                  \
...
&kp LSHFT,            U_MT(LCTRL, U_CUT),   U_MT(LOPT, U_CPY),    U_MT(LCMD, U_PST),    &kp LHYPER,           /***/   &u_caps_word,         U_MS_L,               U_MS_D,               U_MS_R,               U_NU,                  \
