...
&kp CARET,         &kp NUM_7,         &kp NUM_8,         &kp NUM_9,         &kp KP_DIVIDE,     U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
...
&kp LC(LG(Q)),     U_NA,              &kp SH_APPS,       &kp SH_WINS,       &kp SCR_CLP_AREA,  &kp HYPER,         &kp LCMD,          &kp LOPT,          &kp LCTRL,         &kp LSHFT,         \
