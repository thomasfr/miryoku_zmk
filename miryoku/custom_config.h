...
U_MT(LSHFT, A),    U_MT(LCTRL, S),    U_MT(LOPT, D),     U_MT(LCMD, F),     U_MT(HYPER, G),    U_MT(HYPER, H),    U_MT(LCMD, J),     U_MT(LOPT, K),     U_MT(LCTRL, L),    U_MT(LSHFT, SQT),      \
...
&kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LCMD,          &kp HYPER,         U_NA,              &kp C_PREV,        &kp C_VOL_DN,      &kp C_VOL_UP,      &kp C_NEXT,        \
...
&kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LCMD,          &kp HYPER,         &u_caps_word,      &kp LEFT,          &kp DOWN,          &kp UP,            &kp RIGHT,         \
...
U_BOOT,            &u_to_U_TAP,       &u_to_U_EXTRA,     &u_to_U_BASE,      U_NA,              U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
&kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LCMD,          &kp HYPER,         U_NU,              U_MS_L,            U_MS_D,            U_MS_U,            U_MS_R,            \
...
$kp LC(LG(Q)),         U_NA,              &kp C_BRI_DN,      &kp C_BRI_UP,      &kp SCR_AREA,      U_NA,              &u_to_U_BASE,      &u_to_U_EXTRA,     &u_to_U_TAP,       U_BOOT,            \
$kp LC(LG(F6)),        U_NA,              &kp SH_APPS,       &kp SH_WINS,       &kp SCR_CLP_AREA,  &kp HYPER,         &kp LCMD,          &kp LOPT,          &kp LCTRL,         &kp LSHFT,         \
...
&kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LCMD,          &kp HYPER,         &kp HYPER,         &kp LCMD,          &kp LOPT,          &kp LCTRL,         &kp LSHFT,         \
U_UND,             U_CUT,             U_CPY,             U_PST,             U_RDO,             U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,             \
